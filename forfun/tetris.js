var Tetris = function() {
    ...
    //init the game
    return function(adom) {
        adom = adom || "wrapper";
        console.log("init the game");
        console.log(TETRIS_ROWS, TETRIS_COLS);
        // 创建canvas组件
        createCanvas(TETRIS_ROWS, TETRIS_COLS, CELL_SIZE, CELL_SIZE);
        // adom = "wrapper"
        document.getElementById(adom).appendChild(tetris_canvas);
